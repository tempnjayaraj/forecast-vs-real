...
function CompanyDetailForm(){
    ...
    return  <div id="RegistrationFormContainer"><div id="inner"><h1 id="header">Welcome, entrepreneur</h1>
    ...
    <label id= "question">Enter the name of your organization</label><br></br>
    <br></br><div id="ans">
    <input name="org_name" type ="text" id="answer" placeholder="Damaal Dumeel Technologies" required/>
    <p id="log"></p></div>
    </div>
